...
public:
    ...
    MinerCLI() : m_io_work(g_io_service), m_io_work_timer(g_io_service), m_io_strand(g_io_service)
    {
...
private:
    ...
    void doMiner()
    {
        ...
        ApiServer api(
            m_api_address, abs(m_api_port), (m_api_port < 0) ? true : false, m_api_password);
        api.start();
