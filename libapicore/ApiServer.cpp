...
ApiServer::ApiServer(string address, int portnum, bool readonly, string password)
  : m_readonly(readonly),
...
void ApiServer::begin_accept()
{
    ...
    std::shared_ptr<ApiConnection> session =
        std::make_shared<ApiConnection>(++lastSessionId, m_readonly, m_password);
